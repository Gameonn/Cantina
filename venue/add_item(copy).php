        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
          ...
          <aside class="right-side">                
            ...
            <section class="content-header" style="display: -webkit-box;">
               ...
               <div class="menu-dashboard" style="font-family: 'open sans';font-weight: 100;margin-left: 25px;margin-top: 4px;">
...
<div class="row switch_check" style='margin-top: 15px;'>
...
<div class="col-md-5" id="append_tax_text">
 <a class='item-tax btn btn-default btn-sm' style='padding-bottom: 0px;padding-top: 0px;'> Choose Tax</a><br>
 <div class='tax' style='margin-top: 6px;'>
 <div class='well'>
 Taxes would be displayed here based on main category</div>
   ...
   <div class="col-md-4 image-upload" style='margin-top: 15px;'>
