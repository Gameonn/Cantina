              ...
              <div class="body bg-gray">
                    ...
                    <div class="row form-group">
                      ...
                      <label> Fax Number </label><br>
                        <input type="text" name="fax" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask  />
                      </div>  
                      <div class="col-md-6">
                ...
                <div class="col-md-5 image-upload">
                  <img src="../uploads/steam_workshop_default_image.png" class="def-image" style="width: 100%;height: auto; padding: 3px;border: 1px solid rgb(213, 206, 206);
                  border-radius: 4px;">
...
$(document).ready(function () {
	...
	$('#form_submit').click(function(e) { 
		...
		var address=$('#address').val();
		var address=address+',' + city;
		$('.v-address').rules('add', { required: true, }); 
		//alert(address);
		var geocoder =  new google.maps.Geocoder();
